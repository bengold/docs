...
<ParamField body="closePlugin()">
  ...
  <Expandable title="parameters">
    <ParamField path="message" type="string">
      An optional message to show in the toast that will be shown.
    </ParamField>
    <ParamField path="options" type="ClosePluginOptions">
...
<ParamField path="hideUI()">
  Hide the plugin window.
</ParamField>

<ParamField path="setMenu()">
  Register a global plugin menu.
</ParamField>

<ParamField path="showContextMenu()">
  Show a context menu at a given location.
</ParamField>

<ParamField path="showUI()">
  Show the plugin window.
</ParamField>

## User APIs

<ParamField path="getCurrentUser()">
...
<ParamField path="createCodeFile()">
  Create a new code file in the project.
</ParamField>
<ParamField path="getCodeFile()">
  Get a specific code file by its ID.
</ParamField>
<ParamField path="getCodeFiles()">
  Get all code files in the project.
</ParamField>
<ParamField path="subscribeToCodeFiles()">
  Subscribe to changes in code files across the project.
</ParamField>
<ParamField path="subscribeToOpenCodeFile()">
